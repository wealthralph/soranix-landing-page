...
const Footer = () => {
    return (
        <footer className="bg-gray-700 text-white px-20 py-10 flex flex-col lg:flex-row justify-between items-center">
            <section
                id="socialMedia"
                className="w-fit min-h-[75px] flex flex-col justify-between items-center"
            >
                <ul className="flex gap-x-3 pt-10">
            ...
            <section className="pt-10 lg:pt-0">
                <ul className="flex flex-col gap-y-2 lg:block columns-1 text-center lg:columns-6 lg:text-left text-grayBlue">
            ...
            <section className="w-fit min-h-[75px] flex flex-col justify-between items-center">
                <div className="bg-white w-fit rounded-full">
                    <Button className="gradientButton opacityHover pl-6 pr-6 pt-2 pb-2">Send Notifications</Button>
                </div>
                <p className="text-grayBlue text-center mt-4 lg:mt-0">
                    @ Sonarix. All Rights Reserved
                </p>
            </section>
        </footer>
    );
